...
const Navbar = () => {
  ...
  return (
    ...
    <Link to="/" className="text-7xl navbar__logo text-primaryColor">
        Yatra.com
        </Link>
...
{!token && (
  <div className="flex justify-center items-center w-full">
    <Link
      to="/login"
      className="inline-block px-6 py-2 font-semibold text-white transition duration-300 ease-in-out bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full shadow-lg hover:from-indigo-600 hover:to-blue-500 hover:scale-105"
    >
      Login
    </Link>
  </div>
